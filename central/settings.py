...
# Database
# Local: DB_ENGINE=django.db.backends.sqlite3
# VPS:   DB_ENGINE=django.db.backends.postgresql
DATABASES = {
    'default': {
...
ASAAS_BASE_URL = config('ASAAS_BASE_URL', default='https://api.asaas.com/v3')
